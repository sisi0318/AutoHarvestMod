...
public class ClothConfig {
    public static Screen openConfigScreen(Screen parentScreen) {
        ...
        scrolling.addEntry(entryBuilder.startIntSlider(new TranslatableText("config.tick_skip"), c.tickSkip.value, Configure.TickSkip.Min, Configure.TickSkip.Max).setTooltip(new TranslatableText("config.tick_skip_tooltip")).setDefaultValue(new Configure.TickSkip().value).setSaveConsumer(b -> c.tickSkip.value = b).build());
